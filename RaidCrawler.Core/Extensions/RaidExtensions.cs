...
namespace RaidCrawler.Core.Structures
{
    ...
    {
        public static ITeraRaid? GetTeraEncounter(
            this Raid raid,
        ...
        public static (int delivery, int encounter) ReadAllRaids(
            this RaidContainer container,
            byte[] data,
            int storyPrg,
            int eventPrg,
            int boost,
        ...
        public static int GetTeraType(this Raid raid, ITeraRaid? encounter)
        {
            ...
            if (encounter is TeraMight tm && tm.Entity is ITeraRaid9 gemm)
        ...
        private static short GetRateTotalBaseSL(int star) =>
            star switch
            {
                1 => 5800,
                2 => 5300,
        ...
        private static short GetRateTotalBaseVL(int star) =>
            star switch
            {
                1 => 5800,
                2 => 5300,
