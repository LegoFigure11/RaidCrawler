namespace RaidCrawler.Core.Structures
{
    public abstract class Offsets
    {
        ...
        public IReadOnlyList<long> RaidBlockPointerBase = new List<long>() { 0x4622A30, 0x198, 0x88, 0x40 };
        public IReadOnlyList<long> RaidBlockPointerKitakami = new List<long>() { 0x4622A30, 0x198, 0x88, 0xCD8 };
